...
(seed 42, $T = 30$, pop 80): one realistic (province schools, specific
topics) and one after applying the preprocessing that forces every school
...
\begin{figure}[H]
  ...
  \caption{Dual-axis comparison: fitness (solid, left axis, capped at 5000)
           and unserved schools count (dashed, right axis).
           Realistic (red) vs preprocessed (blue).}
